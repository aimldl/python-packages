...
<img src='images/cover-pandas-for-everyone.jpg'>
...
## Folder Structure
- `data/` - datasets used by the notebooks and scripts (gapminder + the book's original datasets)
- `scripts/` - scripts named after their book section (e.g. `4-data-assembly-concatenation.py`), following along with the book
- `ipynb/` - the book author's original Jupyter notebooks, one per chapter
- `output/` - output files (CSV/pickle) generated by running the scripts
- `images/` - book cover image used in this README
